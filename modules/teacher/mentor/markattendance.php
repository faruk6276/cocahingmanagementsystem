                ...
                if(isset($_POST['insert'])) {
                    foreach ($_POST['status'] as $sid_get => $status_insert) {
                        ...
                        if($check >0)
                        {
                            ...
                            $sql_insert = "INSERT INTO attendance (sid, date,timing, eid, batch, status,course, subject) VALUES ('$sid_get', '$date_insert', '$timings_insert', '$eid_insert', '$batch_insert', '$status_insert', '$center_insert','$course_insert','$subject_insert')";
