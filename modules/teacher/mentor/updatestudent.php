...
if($status == 'yes' || $status == 'Yes') {
    if (isset($_GET['studentid'])) {
        ...
        <?php
            $sql_query_search = "SELECT * FROM students WHERE sid='$get_studentid' AND mentor='$eid' AND batch = '$batchmentor'";
